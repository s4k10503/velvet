...
namespace Velvet.Tests
{
    ...
    internal sealed class PooledElementSurfaceResetTests
    {
        ...
        {
            // A toggle whose caption has been cleared reads empty; a fresh one reads null, and no write
            // gets back to it — the label the first caption builds is never dropped.
            ["Toggle.text"] = "",
        };
