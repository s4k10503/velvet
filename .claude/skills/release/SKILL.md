...
none; a minor or a patch leaves it alone. `scripts/release/published_check.py` reads what the pull
request itself does to that section and refuses a release that gets either wrong. That heading is
