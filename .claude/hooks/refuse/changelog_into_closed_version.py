...
def main():
    ...
    if held:
        ...
        print(f"Refusing this {CHANGELOG} edit: it changes `## [{held[0]}]`, and {tag} on the "
              ...
              "heading only above something it comes to head, an entry put back in the same edit "
              "or lines the section already carries, since the section may not come out of the "
              "edit with a heading newly standing over nothing, the put-back's own or one it "
              "empties — or brings the section in as that copy entire, is what this lets "
