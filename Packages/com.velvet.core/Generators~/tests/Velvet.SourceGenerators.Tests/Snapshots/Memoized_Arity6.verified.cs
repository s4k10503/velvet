        /// <summary>
        /// Generic overload for 6 dependencies, so each dep's IEquatable&lt;T&gt; constraint is a
        ...
        /// </summary>
        public static MemoNode Memoized<T1, T2, T3, T4, T5, T6>(Func<VNode> factory, T1? dep1, T2? dep2, T3? dep3, T4? dep4, T5? dep5, T6? dep6)
