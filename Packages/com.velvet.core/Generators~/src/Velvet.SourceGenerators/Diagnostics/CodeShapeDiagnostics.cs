...
namespace Velvet.SourceGenerators.Diagnostics
{
    ...
    internal static class CodeShapeDiagnostics
    {
        ...
        // carry sites it reports and they opt into this category; an error would stop them compiling, and an
        // assembly that does not compile runs none of the rules.
