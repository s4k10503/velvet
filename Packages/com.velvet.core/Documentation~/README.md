...
| [async.md](async.md) | `VelvetTask` — synchronous vs frame-bound continuations in EditMode and PlayMode, what an `async VelvetTask` body may await, and how to test async code |
