...
| [styling-variants.md](styling-variants.md) | The variant set (state / theme `dark:` / responsive `sm:`…`2xl:` / relational `group-`·`peer-` / stacked), how a class payload competes with the base utility in the USS cascade (and why an arbitrary-value payload does not), and container queries (`@container`, the `container-type: inline-size` equivalent) |
