...
namespace Velvet
{
    ...
    internal sealed class FiberNodePatcher
    {
        ...
        // re-scan for it. Divide (child borders) and text-balance (the element's own max-width) touch
        // neither manipulator's properties, so their position is not load-bearing.
