...
namespace Velvet.Tests
{
    ...
    /// member holds — a nested <c>record class</c> of equal content makes the props equal — and where it
    /// transitively holds a <c>float</c> or a <c>double</c>, those leaves are compared by raw bit pattern
    /// on top of that.</item>
