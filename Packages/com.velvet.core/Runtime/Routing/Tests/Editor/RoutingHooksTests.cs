...
namespace Velvet.Tests
{
    ...
    /// flight and exposes the committed location.</item>
    /// <item>While a navigation waits on an Await loader it reports <see cref="NavigationLifecycle.Loading"/>
    /// and the location being navigated to, which is what a pending-UI branch is keyed on.</item>
